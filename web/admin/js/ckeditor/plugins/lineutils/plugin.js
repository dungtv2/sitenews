...
(function() {
    ...
    k.prototype = {start: function(a) {
            ...
            return function(d, b) {
                var c;
                if (b & CKEDITOR.LINEUTILS_AFTER && i(c = d.getNext()) && c.isVisible())
                    a(c, CKEDITOR.LINEUTILS_BEFORE, this.relations), b ^= CKEDITOR.LINEUTILS_AFTER;
                if (b & CKEDITOR.LINEUTILS_INSIDE && i(c = d.getFirst()) && c.isVisible())
            ...
            function a(a, c, e, g, f) {
                for (var h = 0, j; f(e); ) {
                    ...
                    if (j = this.doc.$.elementFromPoint(c, e))
                        if (j == a)
                            h = 0;
                        else if (d(a, j) && (h = 0, i(j = new CKEDITOR.dom.element(j))))
                            return j
                }
            }
    ...
    m.prototype = {removeAll: function() {
            ...
            if (e.top - this.winTopScroll.y < this.rect.top || e.top - this.winTopScroll.y > this.rect.bottom)
                return!1;
            if (this.inline)
                e.left = b.elementRect.left;
            else if (0 < b.elementRect.left ? e.left = this.rect.left + b.elementRect.left : (e.width += b.elementRect.left, e.left = this.rect.left), 0 < (b = e.left + e.width - (this.rect.left + this.winPane.width)))
                e.width -= b;
