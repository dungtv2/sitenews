 ...
 */
public class SelectNewsByUser extends AbstractSearchByAll implements ISelect<news> {

    private ConnectionManager connectManager;
    private Connection con;

    public SelectNewsByUser() {
    ...
    public List<news> select(news t) {
        ...
        try {
            ...
            CallableStatement cs = con.prepareCall("{call sp_searchNewsByUser(?)}");
