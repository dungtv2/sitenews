 ...
 */
public class SelectNewsByTitle extends AbstractSearchByAll implements ISelect<news> {

    private ConnectionManager connectManager;
    private Connection con;

    public SelectNewsByTitle() {
    ...
    public List<news> select(news t) {
        ...
        try {
            ...
            CallableStatement cs = con.prepareCall("{call sp_searchNewsByTitle(?)}");
            cs.setString(1, t.getNews_title());
