 ...
 */
public class SelectNewsByDate extends AbstractSearchByAll implements ISelect<news> {

    private ConnectionManager connectManager;
    private Connection con;

    public SelectNewsByDate() {
    ...
    public List<news> select(news t) {
        ...
        try {
            ...
            CallableStatement cs = con.prepareCall("{call sp_searchNewsByDate(?)}");
            cs.setString(1, t.getNews_date());
