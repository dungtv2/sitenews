 ...
 */
public class SelectNewsByView extends AbstractSearchByAll implements ISelect<news> {

    private ConnectionManager connectManager;
    private Connection con;

    public SelectNewsByView() {
    ...
    public List<news> select(news t) {
        ...
        try {
            ...
            CallableStatement cs = con.prepareCall("{call sp_searchNewsByView(?)}");
            cs.setInt(1, t.getNews_view());
    ...
    public void search(String str) {
        ...
        if (!flag) {
            news.setNews_view(Integer.parseInt(str));
        }
