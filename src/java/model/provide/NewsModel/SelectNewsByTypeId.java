 ...
 */
public class SelectNewsByTypeId extends AbstractSearchByAll implements ISelect<news> {

    private ConnectionManager connectManager;
    private Connection con;

    public SelectNewsByTypeId() {
    ...
    public List<news> select(news t) {
        ...
        try {
            ...
            CallableStatement cs = con.prepareCall("{call sp_searchNewsByType(?)}");
            cs.setString(1, t.getType_id());
